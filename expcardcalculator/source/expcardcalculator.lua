...
function EXPCARDCALCULATOR_ON_INIT(addon, frame)
	...
	if PREVIOUS_SYSMENU_CREATE_ICON == nil then
		...
		acutil.setupHook(EXPCARDCALCULATOR_SYSMENU_CHECK_HIDE_VAR_ICONS_HOOKED, "SYSMENU_CHECK_HIDE_VAR_ICONS");
...
function EXPCARDCALCULATOR_SYSMENU_CHECK_HIDE_VAR_ICONS_HOOKED(frame, isAddon)
	if not isAddon then
	...
	rightMargin = SYSMENU_CREATE_VARICON(frame, status, "expcardcalculator", "expcardcalculator", "sysmenu_card", rightMargin, offsetX, "Experience Card Calculator");
